...
class _InteractiveCityMapPageState extends State<InteractiveCityMapPage> {
  ...
  Future<void> _downloadGeoJson() async {
    final response = await http.get(Uri.parse('https://raw.githubusercontent.com/AshKyd/geojson-regions/master/public/countries/10m/all.geojson'));
    if (response.statusCode == 200) {
      final geoJsonData = response.body;
      myGeoJson.parseGeoJsonAsString(geoJsonData);
      ...
      body: FlutterMap(
        ...
        children: [
          ...
          MouseRegion(
            ...
            if (!loadingData) CircleLayer(circles: myGeoJson.circles),
//              PolygonLayer(
//                simplificationTolerance: 0,
