...
mixin _$RelationChartDataState {
  ...
  GraphDataStatus get graphDataStatus => throw _privateConstructorUsedError;
...
abstract class $RelationChartDataStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      bool isInitDone,
      GraphDataStatus graphDataStatus,
      Graph? graph});
    ...
    return _then(_value.copyWith(
      ...
      isInitDone: null == isInitDone
          ...
          : isInitDone // ignore: cast_nullable_to_non_nullable
              as bool,
      graphDataStatus: null == graphDataStatus
          ? _value.graphDataStatus
          : graphDataStatus // ignore: cast_nullable_to_non_nullable
              as GraphDataStatus,
      graph: freezed == graph
          ? _value.graph
...
class _$RelationChartDataStateImpl implements _RelationChartDataState {
  const _$RelationChartDataStateImpl(
      ...
      this.graphDataStatus = GraphDataStatus.loading,
      this.graph})
      : _labelMap = labelMap,
        _nodeMap = nodeMap,
        _edgeMap = edgeMap,
  ...
  @override
  @JsonKey()
  final GraphDataStatus graphDataStatus;
  @override
  final Graph? graph;

  @override
  String toString() {
    return 'RelationChartDataState(relationChartData: $relationChartData, labelMap: $labelMap, nodeMap: $nodeMap, edgeMap: $edgeMap, labelVisibilityMap: $labelVisibilityMap, edgeTypes: $edgeTypes, nodeToLabelMap: $nodeToLabelMap, edgeToTypeMap: $edgeToTypeMap, forceRefreshFlag: $forceRefreshFlag, isInitDone: $isInitDone, graphDataStatus: $graphDataStatus, graph: $graph)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.graphDataStatus, graphDataStatus) ||
                other.graphDataStatus == graphDataStatus) &&
...
abstract class _RelationChartDataState implements RelationChartDataState {
  ...
  bool get isInitDone;
  @override
  GraphDataStatus get graphDataStatus;
  @override
  Graph? get graph;
  @override
  @JsonKey(ignore: true)
