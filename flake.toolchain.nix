{ pkgs, lib, system, stdenv, fenix, androidSdk }:
# Mostly from https://github.com/NicolaLS/minimint/blob/3469f1afa463cf90a982230888486f0a06f09460/flake.toolchain.nix#L156
# I have no idea what a good portion of this even does
let
  ...
  fake-libgcc-gen = arch: pkgs.stdenv.mkDerivation {
    ...
    installPhase = ''
      ...
      ln -s "`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt | grep ${arch}/libunwind.a`" $out/lib/libgcc.a
    '';
  };
  ...
  androidCrossEnvVars = ''
    ...
    export LLVM_CONFIG_PATH="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/llvm-config$`"

    export CC_armv7_linux_androideabi="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/clang$`"
    export CXX_armv7_linux_androideabi="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/clang++$`"
    export LD_armv7_linux_androideabi="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/ld$`"
    export LDFLAGS_armv7_linux_androideabi="-L `find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ -type d | grep sysroot/usr/lib/arm-linux-androideabi/30$` -L `find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ -type d | grep sysroot/usr/lib/arm-linux-androideabi$` -L ${fake-libgcc-arm}/lib"

    export CC_aarch64_linux_android="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/clang$`"
    export CXX_aarch64_linux_android="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/clang++$`"
    export LD_aarch64_linux_android="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/ld$`"
    export LDFLAGS_aarch64_linux_android="-L `find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ -type d | grep sysroot/usr/lib/aarch64-linux-android/30$` -L `find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ -type d | grep sysroot/usr/lib/aarch64-linux-android$` -L ${fake-libgcc-aarch64}/lib"

    export CC_x86_64_linux_android="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/clang$`"
    export CXX_x86_64_linux_android="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/clang++$`"
    export LD_x86_64_linux_android="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/ld$`"
    export LDFLAGS_x86_64_linux_android="-L `find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ -type d | grep sysroot/usr/lib/x86_64-linux-android/30$` -L `find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ -type d | grep sysroot/usr/lib/x86_64-linux-android$` -L ${fake-libgcc-x86_64}/lib"

    export CC_i686_linux_android="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/clang$`"
    export CXX_i686_linux_android="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/clang++$`"
    export LD_i686_linux_android="`find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ | grep bin/ld$`"
    export LDFLAGS_i686_linux_android="-L `find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ -type d | grep sysroot/usr/lib/i686-linux-android/30$` -L `find ${androidSdk}/libexec/android-sdk/ndk-bundle/toolchains/llvm/prebuilt/ -type d | grep sysroot/usr/lib/i686-linux-android$` -L ${fake-libgcc-i386}/lib"
  '';
  ...
  fenixToolchainCrossAll = with fenix.packages.${system}; combine ([
    ...
    (_: target: targets.${target.name}.stable.rust-std)
    crossTargets));
  ...
  fenixToolchainCross = builtins.mapAttrs
    (_: target: with fenix.packages.${system}; combine [
      stable.cargo
      stable.rustc
